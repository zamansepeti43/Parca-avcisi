...
# Turkish-market aliases used to normalize catalog application text before matching.
ALIASES = {
...
def normalize_make(value: str) -> str:
    v = normalize(value)
    return {'VW':'VOLKSWAGEN','MERCEDES':'MERCEDES-BENZ','MERCEDES BENZ':'MERCEDES-BENZ','CITROËN':'CITROEN'}.get(v,v)
