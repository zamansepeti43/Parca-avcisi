...
create index if not exists ai_learning_examples_status_idx on public.ai_learning_examples(status, created_at desc);
create index if not exists ai_learning_examples_user_idx on public.ai_learning_examples(user_id, created_at desc);
create index if not exists ai_learning_examples_listing_idx on public.ai_learning_examples(listing_id);
...
create policy "users read own ai learning examples" on public.ai_learning_examples for select using (auth.uid() = user_id);

drop policy if exists "users create own ai learning examples" on public.ai_learning_examples;
create policy "users create own ai learning examples" on public.ai_learning_examples for insert with check (auth.uid() = user_id);

drop policy if exists "users update own ai learning examples" on public.ai_learning_examples;
create policy "users update own ai learning examples" on public.ai_learning_examples for update using (auth.uid() = user_id) with check (auth.uid() = user_id);

drop policy if exists "users delete own ai learning examples" on public.ai_learning_examples;
create policy "users delete own ai learning examples" on public.ai_learning_examples for delete using (auth.uid() = user_id);
