...
const LABELS=[['profilim','Profilim'],['araclarim','Araçlarım'],['ilanlarim','İlanlarım'],['taleplerim','Taleplerim'],['mesajlarim','Mesajlarım'],['favorilerim','Favorilerim'],['kayitli-aramalar','Kayıtlı Aramalarım'],['bildirimler','Bildirimler'],['musterilerim','Müşterilerim'],['hesap-bilgileri','Hesap Bilgileri'],['ayarlar','Ayarlar'],['yardim','Yardım & Destek']];
