...
/* Home: keep every major section readable in both themes. */
...
html[data-pa-theme="light"] .marketplace-cta,
html[data-pa-theme="light"] .vehicle-section,
html[data-pa-theme="light"] .how{background:#f5f6f7!important}
html[data-pa-theme="light"] .marketplace-card,
html[data-pa-theme="light"] .category-card,
html[data-pa-theme="light"] .listing-card,
html[data-pa-theme="light"] .steps article{background:#fff!important;color:#171a1e!important;border-color:#dfe3e7!important}
html[data-pa-theme="light"] .marketplace-card p,
html[data-pa-theme="light"] .category-card small,
html[data-pa-theme="light"] .listing-card p,
html[data-pa-theme="light"] .steps p{color:#737c85!important}
...
html[data-pa-theme="light"] .advanced-filter-toggle,
html[data-pa-theme="light"] .advanced-filter-panel{background:#fff!important;color:#171a1e!important;border-color:#d8dde1!important}
html[data-pa-theme="light"] .advanced-filter-grid label{color:#59636d!important}
html[data-pa-theme="light"] .advanced-filter-grid input,
html[data-pa-theme="light"] .advanced-filter-grid select{background:#fff!important;color:#171a1e!important;border-color:#d4d9de!important}
...
html[data-pa-theme="light"] .account-drawer-list button:active,
html[data-pa-theme="light"] .account-drawer-list button:focus-visible{background:#eef1f3!important;color:#171a1e!important}
...
/* Route pages have their own inline dark shell; override it safely with higher specificity. */
...
html[data-pa-theme="light"] body.account-page-runtime .account-pane-head h2,
html[data-pa-theme="light"] body.account-page-runtime .account-pane h2,
html[data-pa-theme="light"] body.account-page-runtime .account-pane h3{color:#171a1e!important}
html[data-pa-theme="light"] body.account-page-runtime .account-page-runtime .pane-loading{color:#69737d!important}
html[data-pa-theme="light"] body.account-page-runtime .form-grid label{color:#68727c!important}
html[data-pa-theme="light"] body.account-page-runtime .form-grid input,
html[data-pa-theme="light"] body.account-page-runtime .form-grid select{background:#fff!important;color:#171a1e!important;border-color:#d2d8dd!important}
html[data-pa-theme="light"] body.account-page-runtime .pane-row,
html[data-pa-theme="light"] body.account-page-runtime .saved-vehicle-row{background:#fff!important;color:#171a1e!important;border-color:#dfe3e7!important}
html[data-pa-theme="light"] body.account-page-runtime .pane-row small,
html[data-pa-theme="light"] body.account-page-runtime .saved-vehicle-row small{color:#6f7881!important}
...
html[data-pa-theme="dark"] body.account-page-runtime .account-pane-head h2,
html[data-pa-theme="dark"] body.account-page-runtime .account-pane h2,
html[data-pa-theme="dark"] body.account-page-runtime .account-pane h3{color:#eef1f4!important}

/* Modals and generic white cards. */
...
function installThemeCss(){
  if(document.getElementById('parca-avcisi-theme-css'))return;
  const style=document.createElement('style'); style.id='parca-avcisi-theme-css'; style.textContent=themeCss; document.head.appendChild(style);
}
...
setTheme(getTheme());
wireThemeEvents();
window.__setParcaTheme=setTheme;
